...
router.post('/create', verifyToken, upload.array('file'), uploadFiles, eventController.postEvent); // Create a new event
router.put('/:eventId', verifyToken, upload.array('file'), uploadFiles, eventController.updateEvent); // Update event details by ID
