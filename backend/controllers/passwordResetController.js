    ...
    try {
        ...
        <head>
          ...
          <style>
            ...
            .container { max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); border-radius: 5px; }
            .header { background-color: #007bff; color: #ffffff; text-align: center; padding: 20px 0; }
            .content { padding: 20px; text-align: center; }
            .reset-link { color: #007bff; text-decoration: none; font-weight: bold; }
            .reset-button { display: inline-block; padding: 10px 20px; background-color: #007bff; color: #ffffff; text-decoration: none; border-radius: 5px; margin-top: 20px; transition: background-color 0.3s; }
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <a class="reset-link" href="${FRONTEND_URL}/reset-password?id=${user._id}&token=${token}">
