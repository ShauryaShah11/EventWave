...
const Signup = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    password: "",
    contactNumber: "",
    companyName: "",         // New field for the company name
    companyAddress: "",      // New field for the company address
  });
            ...
            <Col xs={12} className="d-flex align-items-center justify-content-center">
              <div className="mb-4 mb-lg-0 bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                ...
                <Form className="mt-4" onSubmit={handleRegister}>
                  ...
                  <Form.Group id="companyName" className="mb-3">    {/* New field for the company name */}
                    <Form.Label>Company Name</Form.Label>
                    <InputGroup>
                      <InputGroup.Text>
                        <FontAwesomeIcon icon={faBuilding} />
                      </InputGroup.Text>
                      <Form.Control required type="text" placeholder="Company name" name="companyName" onChange={handleInputChange} />
                    </InputGroup>
                  </Form.Group>
                  <Form.Group id="companyAddress" className="mb-3">    {/* New field for the company address */}
                    <Form.Label>Company Address</Form.Label>
                    <InputGroup>
                      <InputGroup.Text>
                        <FontAwesomeIcon icon={faMapMarkedAlt} />
                      </InputGroup.Text>
                      <Form.Control required type="text" placeholder="Company address" name="companyAddress" onChange={handleInputChange} />
                    </InputGroup>
                  </Form.Group>
